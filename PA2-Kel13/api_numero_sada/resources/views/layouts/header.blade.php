<div id="kt_header" style="" class="header align-items-stretch">
    <!--begin::Brand-->
    <div class="header-brand" style="background-color: rgb(0, 0, 0)">
        <!--begin::Logo-->
        <a href="{{ route('dashboard') }}" class="logo">
            <span><img src="{{ asset('assets/images/logo.png') }}"style="width:70px;height:70px;"
                class="rounded-circle shadow-4-strong" alt="logo"></span>
         </a> <b class="text-white text-hover-primary fs-6 fw-bold"> &nbsp; Numero Sada &nbsp;&nbsp;Futsal</b>
